...
namespace Network
{
    class NetService
    {
        ...
        {
            ServerListener = new TcpSocketListener("192.168.31.138", GameServer.Properties.Settings.Default.ServerPort, 10);
        ...
        public void Start()
        {
            ...
            MessageDistributer.Instance.Start(8);
        ...
        private void OnSocketConnected(object sender, Socket e)
        {
            ...
            NetConnection connection = new NetConnection(e,
                new NetConnection.DataReceivedCallback(DataReceived),
                new NetConnection.DisconnectedCallback(Disconnected), session);
        ...
        /// <param name="e"></param>
        static void Disconnected(NetConnection sender, SocketAsyncEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        static void DataReceived(NetConnection sender, DataEventArgs e)
        {
