...
namespace MMORPG
{
    ...
    {
        public static string AssetDataTablePath => "Assets/DataTable";
        ...
        {
            return Utility.Text.Format("Assets/Localization/{0}/Dictionaries/{1}.{2}", GameLauncher.Localization.Language, assetName, fromBytes ? "bytes" : "xml");
        }
